...
jsonData.baseDir = path.join(__dirname, '..', '.data');

// Create a file if not exists
jsonData.create = function(targetDir, targetFileName, jsonObject, callback) {
    var absolutePath = path.join(jsonData.baseDir, targetDir, helpers.asJsonFile(targetFileName));
...
jsonData.update = function(targetDir, targetFileName, jsonObject, callback) {
    var absolutePath = path.join(jsonData.baseDir, targetDir, helpers.asJsonFile(targetFileName));
...
jsonData.read = function(targetDir, targetFileName, callback) {
    var absolutePath = path.join(jsonData.baseDir, targetDir, helpers.asJsonFile(targetFileName));
...
jsonData.delete = function(targetDir, targetFileName, callback) {
    var absolutePath = path.join(jsonData.baseDir, targetDir, helpers.asJsonFile(targetFileName));
